...
const AddBuyingBill = () => {
    ...
    const addRow = (e) => {
      e.preventDefault()
      document.querySelectorAll(".add-buying-bill table tr:not(.total)").length <= 0 ? setShowRemoveBtn(false) : setShowRemoveBtn(true);
      let tr = document.createElement("tr");
      let lastTr = document.querySelectorAll(".add-buying-bill table tr")[document.querySelectorAll(".add-buying-bill table tr").length - 1]
      console.log(lastTr)
      let table = document.querySelector("add-buying-bill table");
      tr.innerHTML = `
        <td>
      ...
      `
      lastTr.parentElement.insertBefore(tr, lastTr);
    }   
    const removeRow = (e) => {
      e.preventDefault();
      document.querySelectorAll(".add-buying-bill table tr:not(.total)").length === 2 ? setShowRemoveBtn(false) : setShowRemoveBtn(true);
      let lastTr = document.querySelectorAll(".add-buying-bill table tr:not(.total)")[document.querySelectorAll(".add-buying-bill table tr:not(.total)").length - 1]
      let table = document.querySelector(".add-buying-bill table")
                  ...
                  <div className="table-wrapper">
                    <table>
                      ...
                      <div className="add-remove-btns">
                        <div className="add-row" onClick={(e) => {addRow(e)}}>
                          <MainBtn>
                            <FontAwesomeIcon icon={faPlus} />
                          </MainBtn>
                        </div>
                        <div  className="remove-row" onClick={(e) => {removeRow(e)}}
                              style={{display: showRemoveBtn ? "block" : "none"}}
                            >
                          <MainBtn>
