...
const AddTrans = () => {
    ...
    <div className='add-custom'>
        <Breadcumbs pageName={"إضافة عملية النقل"}/>
        <Card>
        <div className="card-block" dir="rtl">
            <h4 className="sub-title">أدخل تفاصيل عملية النقل</h4>
            <form className="row">
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">موقع التنزيل</label>
                    <div className="col-sm-12">
                        <input type="text" className="form-control" placeholder="" />
                    </div>
                </div>
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">اسم المستلم</label>
                    <div className="col-sm-12">
                        <input type="text" className="form-control" placeholder="" />
                    </div>
                </div>
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">رقم الجوال</label>
                    <div className="col-sm-12">
