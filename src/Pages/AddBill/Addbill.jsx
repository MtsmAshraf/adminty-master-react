            ...
            <form className="row">
                <div className="form-group row col-sm-6 col-md-4">
                    ...
                    <div className="col-sm-12">
                        <input type="number" min="0" className="form-control" placeholder="i.g.: 235-53428896" />
                    </div>
                </div>
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">اسم المستورد</label>
                    <div className="col-sm-12">
                        <input type="text" min="0" className="form-control" placeholder="" />
                    </div>
                </div>
                <div className="form-group row col-sm-6 col-md-10">
                    <label className="col-sm-12 col-form-label">اختر اسم المصدر</label>
                    <div className="col-sm-12">
                        <div className="selector-element">
                            <div className="input-div">
                                <label htmlFor="exporter-1">المصدر الأول</label>
                                <input type="radio" name="exporter" id="exporter-1" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="exporter-2">المصدر الثاني</label>
                                <input type="radio" name="exporter" id="exporter-2" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="exporter-3">المصدر الثاااالث</label>
                                <input type="radio" name="exporter" id="exporter-3" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="exporter-4">المصدر الرابع عشر</label>
                                <input type="radio" name="exporter" id="exporter-4" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="exporter-5">المصدر الرابع</label>
                                <input type="radio" name="exporter" id="exporter-5" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="exporter-6">المصدر العاشر</label>
                ...
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">بلد القدوم</label>
                    <div className="col-sm-12">
                ...
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">بلد الوصول</label>
                    <div className="col-sm-12">
                        <select name="select" className="form-control">
                            <option value="">Select Country</option>
                            <option value="Afghanistan">Afghanistan</option>
                ...
                <div className="form-group row col-sm-6 col-md-10">
                    <label className="col-sm-12 col-form-label">المنفذ</label>
                    <div className="col-sm-12">
                        <div className="selector-element">
                            <div className="input-div">
                                <label htmlFor="outlet-1">المنفذ الأول</label>
                                <input type="radio" name="outlet" id="outlet-1" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="outlet-2">المنفذ الثاني</label>
                                <input type="radio" name="outlet" id="outlet-2" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="outlet-3">المنفذ الثاااالث</label>
                                <input type="radio" name="outlet" id="outlet-3" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="outlet-4">المنفذ الرابع عشر</label>
                                <input type="radio" name="outlet" id="outlet-4" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="outlet-5">المنفذ الرابع</label>
                                <input type="radio" name="outlet" id="outlet-5" hidden />
                            </div>
                            <div className="input-div">
                                <label htmlFor="outlet-6">المنفذ العاشر</label>
                ...
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">الوزن</label>
                    <div className="col-sm-12">
                        <input type="number" min="0" className="form-control" placeholder="Kg" />
                    </div>
                </div>
                <div className="form-group row col-sm-6 col-md-4">
                    <label className="col-sm-12 col-form-label">القياسات</label>
                    <div className="col-sm-12">
